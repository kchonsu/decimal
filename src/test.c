...
s21_decimal x = {{int_max, 0, 0, 0b00000000000000000000000000000000}};
...
s21_decimal z = {{0, 0, 0, 0}};
s21_mul(x, y, &z);
char res1[1000], res2[1000] = "3601837252 3619535543 461168601 0";
snprintf(res1, sizeof(char)*1000, "%u %u %u %u", z.bits[0], z.bits[1], z.bits[2], z.bits[3]);
ck_assert_str_eq(res1, res2);
}
END_TEST
...
START_TEST(check_scale_1) {
  s21_decimal x = {{0, 0, 0, 0b10000000000011110000000000000000}};
  int res1 = check_scale(x);
  int res2 = 15;
  ck_assert_int_eq(res1, res2);
}
END_TEST

START_TEST(check_scale_2) {
...
// ----------------------------------------------------------------
// * void scale_dec(s21_decimal *value_1, s21_decimal *value_2);
// * ----------------------------------------------------------------

START_TEST(scale_dec_1) {
...
START_TEST(from_decimal_to_int_6) {
  s21_decimal x = {{100000000, 0, 0, 0b10000000000000000000000000000000}};
  change_scale(&x, 0);
  int y;
  s21_from_decimal_to_int(x, &y);
  ck_assert_int_eq(y, -100000000);
}
END_TEST
...
START_TEST(bank1) {
    s21_decimal x = {{uns_max - 1, uns_max, uns_max, 0}};
...
START_TEST(bank2) {
    s21_decimal x = {{uns_max, uns_max, uns_max, 0}};
    s21_decimal y = {{6, 0, 0, 0}};
    change_scale(&y, 1);
    s21_decimal z = {{0, 0, 0, 0}};
    s21_sub(x, y, &z);
...
int main(void) {
    ...
    tcase_add_test(tc1_1, bank1);
    tcase_add_test(tc1_1, bank2);
    ...
    tcase_add_test(tc1_1, check_scale_1);
    tcase_add_test(tc1_1, check_scale_2);
    tcase_add_test(tc1_1, check_scale_3);
    tcase_add_test(tc1_1, check_scale_4);
    tcase_add_test(tc1_1, check_scale_5);
    tcase_add_test(tc1_1, check_scale_6);
    tcase_add_test(tc1_1, change_scale_1);
    tcase_add_test(tc1_1, change_scale_2);
    tcase_add_test(tc1_1, change_scale_3);
    tcase_add_test(tc1_1, change_scale_4);
    tcase_add_test(tc1_1, change_scale_5);
    tcase_add_test(tc1_1, change_scale_6);
    tcase_add_test(tc1_1, scale_dec_1);
    tcase_add_test(tc1_1, scale_dec_2);
    tcase_add_test(tc1_1, scale_dec_3);
    tcase_add_test(tc1_1, scale_dec_4);
